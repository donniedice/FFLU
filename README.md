...
- <span style="color:#ff6b6b">📢 <strong>First to know</strong></span> <span style="color:#e67e23">about new</span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#e67e23">releases</span>
...
- **<span style="color:#58be81">🎯 Cross-Compatible</span><span style="color:#3598db">:</span>** <span style="color:#e67e23">Works across all</span> <span style="color:#06c">WoW</span> <span style="color:#e67e23">versions</span>
- **<span style="color:#ff6b6b">💬 Active Support</span><span style="color:#3598db">:</span>** <span style="color:#e67e23">Join our Discord for instant help!</span>
...
- **<span style="color:#8B1538">Русский</span>** <span style="color:#3598db">(</span><span style="color:#e67e23">Russian</span><span style="color:#3598db">)</span> <span style="color:#3598db">-</span> _<span style="color:#e67e23">by ZamestoTV</span>_
- **<span style="color:#58be81">Deutsch</span>** <span style="color:#3598db">(</span><span style="color:#e67e23">German</span><span style="color:#3598db">)</span>
- **<span style="color:#4ecdc4">Français</span>** <span style="color:#3598db">(</span><span style="color:#e67e23">French</span><span style="color:#3598db">)</span>
- **<span style="color:#b96ad9">Español</span>** <span style="color:#3598db">(</span><span style="color:#e67e23">Spanish</span><span style="color:#3598db">)</span>
...
1. **<span style="color:#2dc26b">Install</span>** <span style="color:#ffe568">F</span><span style="color:#ffe568">F</span><span style="color:#ffe568">L</span><span style="color:#ffe568">U</span> <span style="color:#e67e23">from your preferred platform</span><span style="color:#3598db">:</span>
   ...
   - [<span style="color:#58be81">WoWInterface</span>](https://www.wowinterface.com/downloads/info26264-FFLU-FinalFantasyLevelUp.html)
...
3. **<span style="color:#b96ad9">Activate</span>**
   1. <span style="color:#e67e23">Restart</span> <span style="color:#06c">World of Warcraft</span>
   2. <span style="color:#e67e23">Enable</span> **<span style="color:#ff6b6b">F</span><span style="color:#ff6b6b">F</span><span style="color:#ff6b6b">L</span><span style="color:#ff6b6b">U</span>** <span style="color:#e67e23">in your AddOns menu</span>
   3. <span style="color:#e67e23">Type</span> `/fflu help` <span style="color:#e67e23">to see all commands!</span>

## <span style="color:#ff6b6b">🎛️ Command Reference</span>

<span style="color:#e67e23">Use</span> `/fflu` <span style="color:#e67e23">followed by</span><span style="color:#3598db">:</span>

<div align="center">

| Command | Description | Example |
|---------|-------------|---------|
| `help` | Show all available commands | `/fflu help` |
| `test` | Play test sound | `/fflu test` |
| `enable` | Enable addon | `/fflu enable` |
| `disable` | Disable addon (unmutes default sound) | `/fflu disable` |
| `high` | Use high quality sound | `/fflu high` |
| `med` | Use medium quality sound | `/fflu med` |
| `low` | Use low quality sound | `/fflu low` |

</div>

## <span style="color:#ff6b6b">🛠️ Advanced Configuration</span>

### <span style="color:#4ecdc4">Settings Persistence</span>
<span style="color:#e67e23">All your settings are automatically saved and restored between gaming sessions using</span> <span style="color:#06c">WoW</span><span style="color:#e67e23">'s SavedVariables system.</span>
...
### <span style="color:#4ecdc4">Troubleshooting</span>
- **<span style="color:#ff6b6b">No sound playing?</span>** <span style="color:#e67e23">Try</span> `/fflu test` <span style="color:#e67e23">to verify installation</span>
- **<span style="color:#2dc26b">Wrong language?</span>** <span style="color:#e67e23">The addon auto-detects your</span> <span style="color:#06c">WoW</span> <span style="color:#e67e23">client language</span>
- **<span style="color:#b96ad9">Settings not saving?</span>** <span style="color:#e67e23">Ensure you have write permissions in your</span> <span style="color:#06c">WoW</span> <span style="color:#e67e23">directory</span>

## <span style="color:#ff6b6b">🎉 What's New in v2.1.18</span>

<details>
<summary><strong><span style="color:#ff6b6b">🎉 Click to see the latest updates!</span></strong></summary>

### <span style="color:#4ecdc4">🆕 Major Updates</span>
- <span style="color:#2dc26b">✅ <strong>Simplified command structure</strong></span> <span style="color:#3598db">-</span> <span style="color:#e67e23">direct sound selection</span>
- <span style="color:#58be81">✅ <strong>Auto-unmute default sound</strong></span> <span style="color:#e67e23">when disabling addon</span>
- <span style="color:#ff6b6b">✅ <strong>Improved performance</strong></span> <span style="color:#e67e23">with optimized code</span>
- <span style="color:#b96ad9">✅ <strong>Updated TOC files</strong></span> <span style="color:#e67e23">with proper formatting</span>
- <span style="color:#4ecdc4">✅ <strong>Removed unnecessary complex commands</strong></span>
- <span style="color:#2dc26b">✅ <strong>Enhanced error handling</strong></span> <span style="color:#e67e23">and stability</span>
- <span style="color:#8B1538">✅ <strong>Russian localization</strong></span> <span style="color:#e67e23">by ZamestoTV (Hubbotu)</span>

### <span style="color:#4ecdc4">🔧 Improvements</span>
- <span style="color:#2dc26b">✅ <strong>Cleaner user experience</strong></span>
- <span style="color:#58be81">✅ <strong>Better memory efficiency</strong></span>
- <span style="color:#ff6b6b">✅ <strong>Consistent</strong></span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#ff6b6b">branding</span>
- <span style="color:#b96ad9">✅ <strong>Updated documentation</strong></span>

### <span style="color:#4ecdc4">🐛 Fixes</span>
- <span style="color:#2dc26b">✅ <strong>Localization initialization issues</strong></span>
- <span style="color:#58be81">✅ <strong>SavedVariables timing problems</strong></span>
- <span style="color:#ff6b6b">✅ <strong>Race condition protection</strong></span>

</details>

## <span style="color:#ff6b6b">🤝 </span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#ff6b6b">Community & Support</span>

### <span style="color:#b96ad9">💬 Join </span> <span style="color:#8B1538">R</span><span style="color:#7598b6">ealm</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#3598db">-</span> <span style="color:#2dc26b">Your Gaming Family!</span>
...
**<span style="color:#ff6b6b">🌟 The heart of </span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#ff6b6b">community!</span>**

</div>

**<span style="color:#ff6b6b">🎯 Why join our Discord?</span>**
- **<span style="color:#2dc26b">⚡ Lightning-fast support</strong></span> <span style="color:#e67e23">from</span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#e67e23">developers</span>
- **<span style="color:#ff6b6b">🎮 Connect with </span> <span style="color:#06c">WoW</span> <span style="color:#ff6b6b">enthusiasts</strong> <span style="color:#e67e23">from around the world</span>
- **<span style="color:#b96ad9">🚀 Beta test new features</strong></span> <span style="color:#e67e23">before anyone else</span>
- **<span style="color:#4ecdc4">💡 Share ideas</strong></span> <span style="color:#e67e23">and influence future</span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#e67e23">development</span>
- **<span style="color:#58be81">🎉 Participate in events</strong></span> <span style="color:#e67e23">and community challenges</span>
- **<span style="color:#ff6b6b">📢 Get notified</strong></span> <span style="color:#e67e23">about new</span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#e67e23">releases instantly</span>

### <span style="color:#4ecdc4">🛠️ Get Help & Support</span>
- **<span style="color:#ff6b6b">🎮 Discord</span><span style="color:#3598db">:</span>** [<span style="color:#8B1538">R</span><span style="color:#7598b6">ealm</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#ff6b6b">Community</span>](https://discord.gg/N7kdKAHVVF) _<span style="color:#e67e23">(Primary Support)</span>_
- **<span style="color:#2dc26b">🐛 Issues</span><span style="color:#3598db">:</span>** [<span style="color:#24292e">GitHub Issues</span>](https://github.com/donniedice/FFLU/issues)
- **<span style="color:#b96ad9">💭 Feature Requests</span><span style="color:#3598db">:</span>** [<span style="color:#24292e">GitHub Discussions</span>](https://github.com/donniedice/FFLU/discussions)
- **<span style="color:#58be81">📧 Contact</span><span style="color:#3598db">:</span>** <span style="color:#e67e23">Reach out via</span> [<span style="color:#24292e">GitHub</span>](https://github.com/donniedice)

### <span style="color:#4ecdc4">🎯 Contributing to </span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span>
<span style="color:#e67e23">The</span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#e67e23">community thrives on collaboration! Here's how you can help</span><span style="color:#3598db">:</span>
- <span style="color:#2dc26b">🐛 <strong>Report bugs</strong></span> <span style="color:#e67e23">and issues</span>
- <span style="color:#ff6b6b">💡 <strong>Suggest new features</strong></span> <span style="color:#e67e23">in our Discord</span>
- <span style="color:#4ecdc4">🌍 <strong>Help with translations</strong></span> <span style="color:#e67e23">for global players</span>
- <span style="color:#b96ad9">📝 <strong>Improve documentation</strong></span> <span style="color:#e67e23">for better user experience</span>
- <span style="color:#58be81">⭐ <strong>Star the repository</strong></span> <span style="color:#e67e23">to show your support</span>
- <span style="color:#ff6b6b">🎮 <strong>Join our Discord</strong></span> <span style="color:#e67e23">and become part of the family!</span>

### <span style="color:#4ecdc4">🏷️ Spread the </span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#4ecdc4">Love</span>
- <span style="color:#2dc26b">💬 <strong>Tell your guildmates</strong></span> <span style="color:#e67e23">about</span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span>
- <span style="color:#ff6b6b">📱 <strong>Share screenshots</strong></span> <span style="color:#e67e23">on social media with #RGXMods</span>
- <span style="color:#b96ad9">⭐ <strong>Write reviews</strong></span> <span style="color:#e67e23">on CurseForge and other platforms</span>
- <span style="color:#4ecdc4">🎥 <strong>Stream with</strong></span> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#e67e23">and show off our addons</span>
- <span style="color:#58be81">🎮 <strong>Invite friends</strong></span> <span style="color:#e67e23">to join the</span> <span style="color:#8B1538">R</span><span style="color:#7598b6">ealm</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#e67e23">Discord!</span>

## <span style="color:#ff6b6b">📄 Legal & License</span>

<span style="color:#e67e23">This project is licensed under the</span> [<span style="color:#24292e">MIT License</span>](https://github.com/donniedice/FFLU/blob/main/LICENSE)<span style="color:#e67e23">.</span>

**<span style="color:#ff6b6b">Disclaimer</span><span style="color:#3598db">:</span>** <span style="color:#e67e23">This addon is provided "as is" without warranty. Use at your own risk. The author is not responsible for any issues arising from its use.</span>

## <span style="color:#ff6b6b">💻 Development Activity</span>

<div align="center">

### <span style="color:#4ecdc4">📊 GitHub Profile Stats</span>
[![GitHub Stats](https://github-readme-stats.vercel.app/api?username=donniedice&show_icons=true&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true)](https://github.com/donniedice)

### <span style="color:#4ecdc4">🏆 GitHub Trophies</span>
[![trophy](https://github-profile-trophy.vercel.app/?username=donniedice&theme=tokyonight&no-frame=true&row=1&column=6&margin-w=15&margin-h=15)](https://github.com/ryo-ma/github-profile-trophy)

### <span style="color:#4ecdc4">🔥 Streak Stats</span>
...
## <span style="color:#ff6b6b">📊 Repository Statistics</span>

<div align="center">

### <span style="color:#4ecdc4">📈 Contribution Activity</span>
[![GitHub Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=donniedice&theme=react-dark&hide_border=true&custom_title=Monthly%20Contribution%20Graph)](https://github.com/donniedice/FFLU)

### <span style="color:#4ecdc4">🌟 Repository Insights</span>

### <span style="color:#4ecdc4">👥 Contributors</span>
<a href="https://github.com/donniedice/FFLU/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=donniedice/FFLU" />
</a>

Made with [contrib.rocks](https://contrib.rocks).

### <span style="color:#4ecdc4">📊 Code Frequency</span>
[![Code Frequency](https://img.shields.io/badge/View-Code%20Frequency-blue?style=for-the-badge&logo=github)](https://github.com/donniedice/FFLU/graphs/code-frequency)
[![Commit Activity](https://img.shields.io/badge/View-Commit%20Activity-green?style=for-the-badge&logo=github)](https://github.com/donniedice/FFLU/graphs/commit-activity)
[![Contributors](https://img.shields.io/badge/View-Contributors-orange?style=for-the-badge&logo=github)](https://github.com/donniedice/FFLU/graphs/contributors)

</div>

## <span style="color:#ff6b6b">📈 Project Metrics</span>

<div align="center">

### <span style="color:#4ecdc4">📊 Repository Stats</span>
| Metric | Value |
|--------|-------|
| **Total Lines of Code** | ![Lines of code](https://img.shields.io/tokei/lines/github/donniedice/FFLU?style=flat-square) |
| **Repository Size** | ![GitHub repo size](https://img.shields.io/github/repo-size/donniedice/FFLU?style=flat-square) |
| **Last Commit** | ![GitHub last commit](https://img.shields.io/github/last-commit/donniedice/FFLU?style=flat-square) |
| **Open Issues** | ![GitHub issues](https://img.shields.io/github/issues/donniedice/FFLU?style=flat-square) |
| **Pull Requests** | ![GitHub pull requests](https://img.shields.io/github/issues-pr/donniedice/FFLU?style=flat-square) |
| **Contributors** | ![GitHub contributors](https://img.shields.io/github/contributors/donniedice/FFLU?style=flat-square) |
| **Languages** | ![GitHub top language](https://img.shields.io/github/languages/top/donniedice/FFLU?style=flat-square) |
| **Watchers** | ![GitHub watchers](https://img.shields.io/github/watchers/donniedice/FFLU?style=flat-square) |
...
[<span style="color:#ff6b6b">🎮 Join our</span> <span style="color:#7289da">Discord</span> <span style="color:#ff6b6b">Community</span>](https://discord.gg/N7kdKAHVVF)
...
[<span style="color:#ff6b6b">☕ Support Development</span>](https://bit.ly/3fyxxSU)
